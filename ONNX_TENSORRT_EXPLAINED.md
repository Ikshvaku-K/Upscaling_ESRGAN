...
When you run [`export_onnx.py`](export_onnx.py):
...
When you run [`trt_convert.py`](src/upscaler/core/trt_convert.py):
...
In [`trt_convert.py`](src/upscaler/core/trt_convert.py#L39), you'll see:
